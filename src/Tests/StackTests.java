...
public class StackTests {
    ...
    public void push_Inserts_To_Head_when_list_is_larger_Test() {
        ...
        Point headPoint = stack.getHead().getElement();
        Point bottomPoint = stack.getHead().getNext().getElement();
    ...
    public void top_returns_head_in_larger_list_Test() {
        ...
        Point returnedPoint = stack.top();
        Point headPoint = stack.getHead().getElement();
        Point secondPoint = stack.getHead().getNext().getElement();
        Point thirdPoint = stack.getHead().getNext().getNext().getElement();
        Node<Point> lastNode = stack.getHead().getNext().getNext();
