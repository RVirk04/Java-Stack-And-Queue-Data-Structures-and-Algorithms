...
public class QueueTest {
    ...
    public void Enqueue_Inserts_To_Head_Test() {
        ...
        Assertions.assertEquals(headPoint, newPoint);
        Assertions.assertEquals(tailPoint, newPoint);
    ...
    public void Enqueue_Inserts_To_Tail_when_list_is_larger_Test() {
        ...
        Assertions.assertEquals(headPoint, point02);
        Assertions.assertEquals(bottomPoint, point01);
    ...
    public void Front_returns_head_in_list_of_1_Test() {
        ...
        Assertions.assertEquals(returnedPoint, point01);
        Assertions.assertEquals(headPoint, returnedPoint);
        Assertions.assertEquals(tailPoint, returnedPoint);
    }
    ...
    public void Front_returns_head_in_larger_list_Test() {
        ...
        Assertions.assertEquals(returnedPoint, point03);
        Assertions.assertEquals(headPoint, returnedPoint);
        ...
        Assertions.assertEquals(secondPoint, point02);
        Assertions.assertEquals(thirdPoint, point01);
        Assertions.assertEquals(thirdPoint, tailNode.getElement());
    ...
    public void Dequeue_returns_head_element_in_list_of_1_Test() {
        ...
        Assertions.assertEquals(oldHeadPoint, returnedPoint);
        Assertions.assertEquals(returnedPoint, point01);
    ...
    public void Dequeue_returns_head_element_in_larger_list_Test() {
        ...
        Assertions.assertEquals(oldHeadPoint, returnedPoint);
        Assertions.assertEquals(returnedPoint, point03);
        Assertions.assertEquals(newHead.getElement(), point02);
        Assertions.assertEquals(lastNode.getElement(), point01);
        Assertions.assertEquals(lastNode.getElement(), tailNode.getElement());
